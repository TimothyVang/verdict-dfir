    ...
    for beat in beats:
        ...
        try:
            ...
            if result.returncode == 0 and result.stdout.strip():
                ...
                print(
                    f"  [enrich] Beat {beat.number} skipped (claude exit {result.returncode})"
                )
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Generate TTS audio for Remotion video beats"
    )
