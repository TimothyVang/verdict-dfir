...
- `docs/reference/mcp-and-tools.md` — the 31 audit-chained product tools (19 Rust + 12 Python) and
  `manifest_verify`. (`.mcp.json` registers 5 servers in total; 3 are operator-runtime.)
