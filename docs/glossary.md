...
| **MCP** | Model Context Protocol — the typed tool interface Claude Code calls. VERDICT exposes 31 product tools across two MCP servers and adds no `execute_shell`. |
