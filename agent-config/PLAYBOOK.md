...
### Rust `findevil-mcp` (43) — DFIR primitives, read-only on evidence, SHA-256 every output
...
### Python `findevil-agent-mcp` (14) — reasoning, crypto/custody, memory; run in the reason/seal phase
